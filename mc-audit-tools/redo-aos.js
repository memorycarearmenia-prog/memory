...
for(const lang of LANGS){
  ...
  const st=await p.evaluate(()=>{document.documentElement.style.scrollBehavior="auto";window.scrollTo(0,2300);const els=[...document.querySelectorAll('[data-aos]')];return {total:els.length,animated:els.filter(e=>e.classList.contains('aos-animate')).length};});
